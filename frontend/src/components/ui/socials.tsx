...
const socialsData = [
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/patrick-martinez-b6a360331/",
    bgColor: "bg-sky-700",
  ...
  {
    name: "GitHub",
    href: "https://github.com/Springroll321",
    bgColor: "bg-zinc-800",
  ...
  {
    name: "Email",
    href: "mailto:pmartinez2972@gmail.com",
  ...
  return (
    <div className="flex space-x-8">
      {socialsData.map((social) => (
        ...
        >
          <button
            className={`w-24 h-24 rounded-full ${social.bgColor} flex items-center justify-center transform transition-transform duration-300 hover:scale-125 ${social.hoverColor}`}
          >
            {social.icon}
          </button>
        </a>
