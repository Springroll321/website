      ...
      {/* MAKER SECTION */}
        <div className={containerClass}>
          <div>
            ...
            I am passionate about making  things either through traditional crafts like woodworking and crocheting, or through digital creation such as 3D modeling and coding.
            I enjoy the mix of creativity, problem-solving, and experimentation that comes with every project.
            </p>
          </div>
          <Carousel 
            images={makerImages} 
